...
readonly ARCHIVE="jira_${LATEST_TAG}_linux_x86_64.tar.gz"
readonly URL_DOWNLOAD="https://github.com/ankitpokhrel/jira-cli/releases/download/v${LATEST_TAG}/${ARCHIVE}"
readonly URL_CHECKSUMS="https://github.com/ankitpokhrel/jira-cli/releases/download/v${LATEST_TAG}/checksums.txt"

_tmparchive=$(mktemp --suffix=-"${ARCHIVE}")
w_download "${URL_DOWNLOAD}" "${_tmparchive}"
