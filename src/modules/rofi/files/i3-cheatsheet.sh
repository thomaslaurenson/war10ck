...
===  STACKING WORKFLOWS  ============================================
  ...
  mod+v -> mod+Shift+Left -> mod+s    Pull an existing window into stack
  mod+Up / mod+Down                   Cycle through stacked windows
===  WINDOW FOCUS & MOVE  ===========================================
  mod+Left / Right / Up / Down        Focus window in direction
  mod+Shift+Left / Right / Up / Down  Move window (enters adjacent container if one)
